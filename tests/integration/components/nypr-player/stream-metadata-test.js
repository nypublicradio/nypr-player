...
moduleForComponent('nypr-player/stream-metadata', 'Integration | Component | nypr player/stream metadata', {
  integration: true
});

test('it shows streamsIndexUrl if provided', function(assert) {
  this.set('streamsIndexUrl', 'http://streamsindex/');
  this.render(hbs`{{nypr-player/stream-metadata streamsIndexUrl=streamsIndexUrl}}`);
...
test('it shows streamPlaylistUrl if provided', function(assert) {
  ...
  this.render(hbs`{{nypr-player/stream-metadata streamPlaylistUrl=streamPlaylistUrl}}`);
...
test('it shows streamScheduleUrl', function(assert) {
  ...
  this.render(hbs`{{nypr-player/stream-metadata streamScheduleUrl=streamScheduleUrl}}`);
